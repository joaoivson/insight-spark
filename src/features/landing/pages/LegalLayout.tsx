...
const LegalLayout = ({ title, updatedAt, children }: LegalLayoutProps) => (
  <div className="min-h-screen bg-background text-foreground">
    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="legal-content mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-foreground [&_a]:text-primary [&_a]:underline [&_strong]:text-foreground [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-1">
        {children}
      </div>
