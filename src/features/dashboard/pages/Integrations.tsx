          ...
          <div className="flex items-start gap-3 md:gap-4 mb-6">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-muted-foreground">
                Sincroniza automaticamente suas <strong>comissões</strong> de hora em hora (últimos 7 dias) e um reconcile
                completo na madrugada. Dados de cliques não estão disponíveis via API e devem ser importados via Upload
                Cliques.
              </p>
            </div>
          </div>
