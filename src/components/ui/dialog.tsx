...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // max-w-[calc(100%-2rem)] + rounded-lg: sem eles o modal encosta nas
        // duas bordas em 390px. Mesmas classes do shadcn atual — um
        // `shadcn add dialog` reescreve com o equivalente, não regride.
